...
APPROVED_AGGREGATE_RUNTIME_SCRIPT = "aggregate-task-list.js"
APPROVED_SESSION_RUNTIME_SCRIPT = "session-list.js"
APPROVED_SESSION_DETAIL_RUNTIME_SCRIPT = "session-detail.js"
...
APPROVED_RUNTIME_SCRIPTS = {
    ...
    APPROVED_AGGREGATE_RUNTIME_SCRIPT,
    APPROVED_SESSION_RUNTIME_SCRIPT,
    APPROVED_SESSION_DETAIL_RUNTIME_SCRIPT,
