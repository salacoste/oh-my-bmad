...
def test_worker_facing_source_code_unchanged() -> None:
    ...
    SPINE_PATHS = list(_WORKER_FACING_PATHS) + [
        ...
        # coupling change; runtime separability remains covered by the S-2
        # mid-flight stub-worker swap above.
        ...
        # None of those fall under _WORKER_FACING_PATHS (line 47 covers only
