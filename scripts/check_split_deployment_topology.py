...
RUNTIME_PATH_POLICY = RuntimePathPolicy(
    excluded_prefixes=(
        ...
        "scripts/check_operator_dashboard_split.py",
        "scripts/check_horizontal_scaling_readiness.py",
        "scripts/check_failure_load_backup_restore_readiness.py",
        "scripts/check_split_deployment_remote_postgres_closure.py",
        "_bmad-output/implementation-artifacts/",
    ),
