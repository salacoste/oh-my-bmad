...
def test_render_plan_ready_basic() -> None:
    ...
    assert "Plan ready (t-00000000-0000-7000-8000-000000000010), 3 steps:" in result
...
def test_render_plan_ready_empty_steps() -> None:
    ...
    result = _render_plan_ready(env)
    assert result == "Plan ready (t-00000000-0000-7000-8000-000000000010), 0 steps:"
...
def test_render_plan_ready_single_step() -> None:
    ...
    result = _render_plan_ready(env)
    assert "Plan ready (t-00000000-0000-7000-8000-000000000010), 1 steps:" in result
...
def test_render_plan_ready_emergency_one_liner() -> None:
    ...
    assert "Plan ready (t-00000000-0000-7000-8000-000000000010), 30 steps:" in result
...
def test_render_plan_ready_step2_ladder_truncation() -> None:
    ...
    result = _render_plan_ready(env)
    assert "Plan ready (t-00000000-0000-7000-8000-000000000010), 15 steps:" in result
...
def test_render_plan_ready_v1_0_0_backward_compat() -> None:
    ...
    result = _render(env)
    assert "Plan ready (t-00000000-0000-7000-8000-000000000011), 0 steps:" in result
