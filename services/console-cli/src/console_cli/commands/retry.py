"""retry command — POST /v1/tasks/{task_id}/decisions action=retry (Story 4.3 AC-4)."""
...
def retry(
    ...
    hint: str | None = typer.Option(None, "--hint", help="Hint for the next planning pass"),
) -> None:
    """Retry a failed task."""
    ...
    print(f"Retrying {result.task_id} ({result.decision_id}).")
