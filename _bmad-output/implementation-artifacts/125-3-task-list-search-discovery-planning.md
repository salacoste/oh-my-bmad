...
Search/discovery is not selected for runtime in Phase 46 and requires a separate product/architecture contract.

## Planning constraints

- Define exact searchable fields and query grammar before any runtime work.
- Define authority/freshness/provenance/privacy and sort/pagination interactions.
- No free-text search, arbitrary discovery, hidden selectors, generated data, or automatic traversal authorization.
